...
const ProgressRing = ({ size = 200, onFinish }) => {
  ...
  const getMessage = () => {
    ...
    if (step === 2) return 'Este es tu capital. Empieza pequeño, pero puede crecer cada vez que conservas una parte de tu ingreso.';
    if (step === 3) return 'Esta línea representa un año de tu vida. En cada punto tendrás oportunidad de crecer tu capital.';
  };
